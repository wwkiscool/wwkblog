<template>
  <div>
    ...
    <div class="MobileTopBar">
      <div class="MobileTopBarLogo" @click="ChangeRouter('BlogIndex')">title</div>
    ...
    <div class="MobileMenuDetail" v-if="OpenMobileMenu" @click="OpenMenu()">
      <div class="MoblieMenuDetailContent">
        ...
        <div :class="Active == 6 ? 'MobileMenuDetailItemActive' : 'MobileMenuDetailItem'" @click="openUrl()">管理后台
        </div>
      </div>
