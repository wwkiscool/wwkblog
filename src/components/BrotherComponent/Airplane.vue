<template>
    <div class="Airplane">
        <div class="Item" v-show="Show" @click="BackTop()"><i
                class="iconfont icon-4fanhuidingbubai IconfontSizeAirplane"></i></div>
    </div>
</template>
...
const BackTop = () => {
    let ScrollHeigh = document.documentElement.scrollTop || window.pageYOffset || document.body.scrollTop,
